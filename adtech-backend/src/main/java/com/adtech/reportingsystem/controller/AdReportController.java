...
// import com.adtech.reportingsystem.service.ReportService;
// import com.adtech.reportingsystem.service.CsvImportService;
// import com.adtech.reportingsystem.service.ReportService.ReportQueryRequest; // <--- ENSURE THIS IMPORT IS PRESENT
// import com.adtech.reportingsystem.dto.AdReportDto; // <--- ENSURE THIS IMPORT IS PRESENT
// import org.slf4j.Logger;
// import org.slf4j.LoggerFactory;
// import org.springframework.beans.factory.annotation.Autowired;
// import org.springframework.data.domain.Page;
...
public class AdReportController {
    ...
    // --- CRITICAL FIX: Updated mapping to match new AdReportDto field names ---
    private AdReportDto convertToDto(AdReportData adReportData) {
        AdReportDto dto = new AdReportDto();
        dto.setId(adReportData.getId());
        dto.setMobileAppResolvedId(adReportData.getMobileAppResolvedId()); // New mapping
        dto.setMobileAppName(adReportData.getMobileAppName());
        dto.setDomain(adReportData.getDomain());                            // New mapping
        dto.setAdUnitName(adReportData.getAdUnitName());
        dto.setAdUnitId(adReportData.getAdUnitId());                        // New mapping
        dto.setInventoryFormatName(adReportData.getInventoryFormatName());
        dto.setOperatingSystemVersionName(adReportData.getOperatingSystemVersionName());
        dto.setDate(adReportData.getDate());
        dto.setAdExchangeTotalRequests(adReportData.getAdExchangeTotalRequests());
        dto.setAdExchangeResponsesServed(adReportData.getAdExchangeResponsesServed());
        dto.setAdExchangeMatchRate(adReportData.getAdExchangeMatchRate());
        dto.setAdExchangeLineItemLevelImpressions(adReportData.getAdExchangeLineItemLevelImpressions());
        dto.setAdExchangeLineItemLevelClicks(adReportData.getAdExchangeLineItemLevelClicks());
        dto.setAdExchangeLineItemLevelCtr(adReportData.getAdExchangeLineItemLevelCtr());
        dto.setAverageEcpm(adReportData.getAverageEcpm());
        dto.setPayout(adReportData.getPayout());
        return dto;
    }
